 ...
 */
export function generateICSFile(events: Event[], calendarName: string = "IndieCraft Events"): string {
  const lines: string[] = [
    "BEGIN:VCALENDAR",
    "VERSION:2.0",
    "PRODID:-//IndieCraft//Schedule//EN",
 ...
 */
export function downloadICSFile(events: Event[], filename: string = "indiecraft-events.ics"): void {
